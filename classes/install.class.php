...
if( ! class_exists( 'yaawp_install' ) ) {
    ...
    class yaawp_install extends yaawp {
        ...
        function addOptions() {
            ...
            add_option( 'yaawp_product_template', '', '', 'no' );
            add_option( 'yaawp_product_number', 6, '', 'yes' );
            add_option( 'yaawp_product_layout', 'grid', '', 'yes' );

            $options = array(
                'yaawp_product_social_enable' => 1,
                'yaawp_product_social_size' => 16,
                'yaawp_product_social_list' => array('delicious','digg','reddit','twitter')
            );

            add_option( 'yaawp_product_social', $options, '', 'no' );
        ...
        function delOptions() {
            ...
            delete_option( 'yaawp_product_template' );
            delete_option( 'yaawp_product_number' );
            delete_option( 'yaawp_product_layout' );

            delete_option( 'yaawp_product_social' );
