...
get_header(); ?>
    ...
    <div id="primary" class="site-content product3">
        <div id="content" role="main">
            ...
            <div style="position: relative;background: transparent url('<?php echo pluginUrl; ?>assets/img/HeCoSep.png') bottom left repeat-x;padding-bottom: 20px;margin-bottom: 20px;color: #444;">
                ...
                <div style="padding: 6px;border: #a8a8a8 solid 1px;display: block;">
                    ...
                    <div style="margin-top: 10px;width: 250px;float: left;">
                        ...
                        <!-- Verfuegbarkeit -->
                        <div style="height: 65px;background: transparent url('<?php echo pluginUrl; ?>assets/img/HeCoSep.png') bottom left repeat-x;padding-bottom: 10px;margin-bottom: 10px;">
                            <div style="padding-left: 10px;width: 230px; float: left;">
                                ...
                                <div style="margin-top: 5px;line-height: 1.5em;font-weight: 700;">
                                    ...
                                    <div style="line-height: 1.5em;background-position: 0 0;background-repeat: no-repeat;padding-left: 28px;float: left;background-image: url('<?php echo pluginUrl; ?>assets/img/verfuegbar.png');min-height: 28px;padding: 2px 0 2px 30px;color: #95CD00;">
                                         <?php echo get_post_meta($post->ID, 'Availability', true); ?>
                                    </div>
                                    <?php else: ?>
                                    <div style="line-height: 1.5em;background-position: 0 0;background-repeat: no-repeat;padding-left: 28px;float: left;background-image: url('<?php echo pluginUrl; ?>assets/img/nicht_verfuegbar.png');min-height: 28px;padding: 2px 0 2px 30px;color: #b94a48;">
                                         <?php echo get_post_meta($post->ID, 'Availability', true); ?>
                                    </div>
                                    <?php endif; ?>
                                </div>
                        ...
                        <div style="width: 100%;float: left;">
                            ...
                            <div style="background: #e60000 url('<?php echo pluginUrl; ?>assets/img/preis_naht.png') bottom left repeat-x;color: #fff;min-width: 155px;height: 45px;padding: 10px;text-align: center;font-family: 'LeagueGothicRegular', sans-serif;">
                            ...
                            <div style="height: 18px;text-transform: uppercase;font-size: 140%;padding: 10px;text-align: center;font-family: 'LeagueGothicRegular', sans-serif;background-color: #CCE0E9;color: #006291;">
                                <a href="<?php echo get_post_meta($post->ID, 'DetailPageURL', true); ?>" style="color: #006291;background-position: 0 0;background-repeat: no-repeat;padding-left: 28px;float: left;line-height: 26px;vertical-align: middle;background-image: url('<?php echo pluginUrl; ?>assets/img/in_den_warenkorb.gif');text-decoration: none; float: right;" class="wc"  rel="external nofollow" target="_blank">Produkt Kaufen</a>
